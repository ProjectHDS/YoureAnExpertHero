...
public class EnderMethod extends AbstractHeckMethod {
    public EnderMethod() {
        super(9);
    }
    ...
    public Optional<String> getRequiredImports() {
        return Optional.of("import mods.extendedcrafting.EnderCrafting;");
    }

    @Override
    public String removeExistingRecipe(ItemStack output) {
        return String.format("EnderCrafting.remove(%s)", stackToBracket(output));
    }
    ...
    public String writeZenscript(String recipeName, ItemStack output, List<ItemStack> inputs) {
        ...
        if (random.nextBoolean()) {
            return String.format("EnderCrafting.addShapeless(%s, [%s], %s);",
                    stackToBracket(output),
                    stacksToBracketedList(inputs),
                    random.nextInt(114514)
            );
        }
        return String.format("EnderCrafting.addShaped(%s, [%s,\n  %s,\n  %s], %s);",
                stackToBracket(output),
    ...
    public List<ItemStack> getRequiredItems() {
        return ImmutableList.of(new ItemStack(ModBlocks.blockEnderCrafter, 1, 0), new ItemStack(ModBlocks.blockEnderAlternator, 1, 0));
    }
    ...
    public Pair<Pair<List<ItemStack>, String>, Boolean> chooseInputs(HeckData allHeck, Heck.GoodItemStack outputGood, boolean base) throws Heckception {
        ...
        while (!(sanity)) {
            ...
            YoureAnExpertHarry.LOGGER.info("Sanity-checking EnderCrafting recipes.");
